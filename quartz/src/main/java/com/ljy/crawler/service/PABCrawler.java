...
public class PABCrawler {
    ...
    public static List<Map<String, Object>> crawling(String seeds) {
        ...
        List<Map<String, Object>> list = PageParserTool.getAllByNameFromPAB(newPage, "table");
        return list;
    ...
    public static void main(String[] args) {
       System.out.println(PABCrawler.crawling("http://bank.pingan.com/geren/waihuipaijia.shtml"));
    }
}